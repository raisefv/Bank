...
namespace Bank.Classes
{
    class Transactions
    {
        ...
        public Transactions(string accountNumber, OperationType operation, DateTime timestamp, bool isSuccessful, decimal amount, string getterAccountNumber, string senderAccountName, string getterAccountName)
        {
